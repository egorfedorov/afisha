...
class Owner extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model(array('mowner', 'mimages'));
		$this->data['menu_section'] = 'owner';
		$this->data['msg'] = false;	
	}
	...
	function submit()
	{
		...
		{
			$article_id = $this->mowner->add_owner($article);
			$this->data['msg']['type'] = 'succeed';
			$this->data['msg']['text'] = 'Место "'.$article['category_name'].'" добавлена.';
		}
